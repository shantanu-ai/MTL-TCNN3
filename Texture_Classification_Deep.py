...
class Texture_Classification_Deep:
    ...
    def kylberg_Train_test():
        ...
        # device = 'cuda' if torch.cuda.is_available() else 'cpu'
        print(device)
        TEXTURE_LABELS = ["blanket1-with-rotations", "blanket2-with-rotations", "canvas1-with-rotations",
                          "ceiling1-with-rotations", "ceiling2-with-rotations", "cushion1-with-rotations",
