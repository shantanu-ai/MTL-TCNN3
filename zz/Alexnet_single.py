...
class Alex_netCNN(nn.Module):
    def __init__(self, image_net_labels, device):
        super(Alex_netCNN, self).__init__()
        ...
        self.object_out = nn.Linear(in_features=4096, out_features=len(image_net_labels))
    ...
    def forward(self, x):
        ...
        object_head = F.relu(self.object_out(object_head))
