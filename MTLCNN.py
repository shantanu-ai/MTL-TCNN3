...
class MTLCNN(nn.Module):
    def __init__(self, init_weights, texture_labels, image_net_labels, device):
        ...
        self.object_detect_fc3 = nn.Linear(in_features=4096, out_features=len(image_net_labels))
    ...
    def forward(self, x):
        ...
        object_head = self.pool(object_head)
        ...
        object_head = F.relu(self.object_detect_fc3(object_head))

        # texture classification
        texture_head = x.mean(dim=(2, 3))
