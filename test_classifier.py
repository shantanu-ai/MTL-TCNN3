...
class Test_Classifier:
    ...
    def test_classifier_single(self, test_parameters, device):
        return self.__test_single(test_parameters, device)

    def __test_single(self, test_parameters, device):
        ...
        for data_loader in data_loader_test_list:
            ...
            for batch in data_loader:
                ...
                texture_corrects += Util.get_num_correct(outputs, label)
